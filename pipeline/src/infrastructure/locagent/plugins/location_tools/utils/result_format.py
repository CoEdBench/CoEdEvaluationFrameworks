...
from src.infrastructure.locagent.plugins.location_tools.utils.compress_file import get_skeleton
...
class QueryResult:
    ...
    def __init__(self, query_info: QueryInfo, format_mode: str, 
        ...
        # Perform different initialization logic based on input parameters
        if nid is not None:
            self.nid = nid
